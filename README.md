...
- 🎯 Entry points to execute your program using `python -m <lux_template>` or `$ lux_template` with basic CLI argument parsing.
...
```py
from lux_template import BaseClass
from lux_template import base_function
